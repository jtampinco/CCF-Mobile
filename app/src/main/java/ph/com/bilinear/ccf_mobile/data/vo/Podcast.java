...
public class Podcast {
    ...
    public Podcast(String title, Drawable thumbnail, Drawable banner, String speaker, String location, String date, String time, String content, String person, String number, String email) {
        this.title = title;
